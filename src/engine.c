...
#include "DataStructures/Lines2D.h"
#include "utils.h"
...
void run() {
    ...
    // Create a SDL window
    SDL_Window *window = SDL_CreateWindow("Hello, SDL2", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, window_width,
    ...
    Lines2D *lines2d = createRectangle();
